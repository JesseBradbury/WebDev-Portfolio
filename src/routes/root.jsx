...
export default function Root() {
    return (
        <>
            ...
            <p>Welcome to my web development portfolio! I am currently enrolled in the ASU Web Development
                Bootcamp.<br></br>
